...
→ এটি `student` টেবিল থেকে `ID` ও `name` আনবে। কিন্তু কাদের?

#### 📌 WHERE NOT EXISTS (...)

→ আমরা এমন student চাই যাদের জন্য নিচের সাব-কোয়্যারি **"false"** হয়। অর্থাৎ যাদের কোনো Biology কোর্স বাদ যায়নি।
...
→ এটি `course` টেবিল থেকে Biology ডিপার্টমেন্টের সব `course_id` বের করে।
...
→ এটি বলে, নির্দিষ্ট student কোন কোন কোর্স নিয়েছে।
...
→ এটি দেখায়, Biology ডিপার্টমেন্টের কোন কোন কোর্স **নেই** student-এর নেওয়া কোর্সের তালিকায়।

✅ যদি **EXCEPT-এর ফলাফল ফাঁকা হয়**, তাহলে বুঝি student ওই department-এর **সব** কোর্স নিয়েছে।

---

## 🗂️ লাগা টেবিলসমূহ:

| Table Name | দরকার কেনো                                      |
| ---------- | ----------------------------------------------- |
| `student`  | Student এর ID ও name আনতে                       |
| `course`   | Biology ডিপার্টমেন্টে কী কী course আছে তা জানতে |
| `takes`    | কোন student কোন course নিয়েছে তা জানতে          |
